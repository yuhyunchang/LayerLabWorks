...
namespace LayerLabAsset
{
    public class Create2DPatternGridWindow : EditorWindow
    {
        ...
        [MenuItem("LayerLabAsset/Create 2D Pattern Grid", false, 104)]
        public static void ShowWindow()
        {
            var window = GetWindow<Create2DPatternGridWindow>("Create 2D Pattern Grid");
        ...
        private void OnGUI()
        {
            ...
            {
                Undo.RegisterFullObjectHierarchyUndo(targetObject, "Auto Rebuild Pattern Grid");
            ...
            {
                Undo.RegisterFullObjectHierarchyUndo(targetObject, "Rebuild Pattern Grid");
                ClearGrid(targetObject.transform);
                BuildGrid(targetObject.transform);
            }
            ...
            {
                Undo.RegisterFullObjectHierarchyUndo(targetObject, "Clear Pattern Grid");
                ClearGrid(targetObject.transform);
            }
        ...
        private void CreateItem(Transform parent, GameObject prefab, Vector3 localPos)
        {
            ...
            Undo.RegisterCreatedObjectUndo(instance, "Create Pattern Grid Item");
        }
